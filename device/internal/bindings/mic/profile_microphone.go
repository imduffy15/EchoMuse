...
//
// The ALSA ring here is only PeriodSize x Periods frames deep — on checkers
// that is 257 x 4 = ~64 ms — so any stall in this chain longer than that
// drops whole periods at the hardware with no error surfaced. The telemetry
